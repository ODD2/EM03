...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->loadImageToolStripMenuItem->Size = System::Drawing::Size(384, 30);
			...
			this->setResultImageAsSourceImageToolStripMenuItem->Size = System::Drawing::Size(384, 30);
			...
			this->fastFourierTransformToolStripMenuItem->Size = System::Drawing::Size(384, 30);
			...
			this->inverseFastFourierTransformToolStripMenuItem->Size = System::Drawing::Size(384, 30);
			...
			this->lowpassFilterToolStripMenuItem->Size = System::Drawing::Size(384, 30);
			...
			this->highpassFilterToolStripMenuItem->Size = System::Drawing::Size(384, 30);
			...
			this->discreteFourierTransformToolStripMenuItem->Size = System::Drawing::Size(384, 30);
			...
			this->inverseDiscreteFourierTransformToolStripMenuItem->Size = System::Drawing::Size(384, 30);
...
private: System::Void fastFourierTransformToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	int w = dataManager->GetImageWidth();
	int h = dataManager->GetImageHeight();
	fourierTransformMethod->FastFourierTransform(dataManager->GetInputImage(), dataManager->GetOutputImage(), dataManager->GetCImage(), h, w);
...
private: System::Void inverseFastFourierTransformToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	int w = dataManager->GetImageWidth();
	int h = dataManager->GetImageHeight();
	fourierTransformMethod->InverseFastFourierTransform( dataManager->GetOutputImage(), dataManager->GetCImage(), h, w);
...
private: System::Void lowpassFilterToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	fourierTransformMethod->LowpassFilter( dataManager->GetOutputImage(),dataManager->GetCImage(), h, w,5,1);
...
private: System::Void highpassFilterToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	fourierTransformMethod->HighpassFilter( dataManager->GetOutputImage(), dataManager->GetCImage(),h, w, 5, 1);
